...
import noMoviePoster from '../assets/pageNotFound.jpg'
...
export const MovieDetail = () => {
  ...
  const{poster_path,genres} =movie
  const poster = poster_path ? `https://image.tmdb.org/t/p/w500/${poster_path}` : noMoviePoster 
  return (
