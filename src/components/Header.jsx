...
export const Header = () => {
    ...
    const nonActive = "text-base block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
    ...
    function handleSearch(event){
      ...
      const queryParams = event.target.search.value
      event.target.reset()
  ...
  return (
    ...
    <>
      <nav className="bg-white border-gray-200 dark:bg-gray-900 border-b-2 dark:border-b-2 dark:border-slate-700 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div
            className={`${mobileNav?"":"hidden"} items-center justify-between  w-full md:flex md:w-auto md:order-1`}
            id="navbar-search"
          >
